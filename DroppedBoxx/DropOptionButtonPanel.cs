...
{
    public class DropOptionButtonPanel : FluidPanel
    {
        ...
        protected override void OnSizeChanged(System.Drawing.Size oldSize, System.Drawing.Size newSize)
        {
            ...
            int ButtonTop = ScaleY(DropOptionButtonPanel.ButtonTop);

            if (Width > Height)
            {
                int Space = ScaleX(DropOptionButtonPanel.Space);
            ...
            {
                int Space = ScaleY(DropOptionButtonPanel.Space);
                btn1.Bounds = new Rectangle(Space, ButtonTop, buttonWidth, buttonHeight);
